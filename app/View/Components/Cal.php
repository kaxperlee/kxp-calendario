...
class Cal extends Component
{
     ...
     * @return void
     */
    public function __construct($month="", $fontsize="fs-5", $color="text-dark", $fondo="bg-white", $localidad=1, $comunidad=1)
    {
        ...
        while ($iweek < $semana):
            ...
            for ($iday=0; $iday < 7 ; $iday++){
              ...
              //echo "<h3>".$datanew['festivo2']."</h3>";
                ...
                //FESTIVOS
              if ($festivo = Evento::where("fecha",$datafecha)
                ->where(function ($query) use ($comunidad,$localidad) {
                $query->where('Evento', 'n')
                      ->orWhere('comunidad_id', $comunidad)
